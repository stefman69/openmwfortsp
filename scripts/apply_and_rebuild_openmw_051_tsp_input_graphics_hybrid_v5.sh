...
#   - Menu   = evdev code 316
#
# There is intentionally no custom mouse/cursor mode in V5. The goal is to keep
# OpenMW's native gamepad controls completely untouched outside text entry.
#
...
OUTPUT_BINARY="${4:-/root/openmw-0.51-tsp-input-graphics-v5}"
...
SCRIPT_REVISION="TSP-051-AUTO-TEXT-GRAPHICS-V5-2026-08-07"
