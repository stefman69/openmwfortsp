...
#
# SAFETY GUARANTEES:
#   * Never deletes, cleans, or re-clones /root/gl4es-tsps.
...
#
# Output:
#   /root/gl4es-tsps-export-o3/libGL.so.1
#   /root/gl4es-tsps-o3.tar.gz
#
set -Eeuo pipefail

SOURCE_DIR="/root/gl4es-tsps"
BUILD_DIR="$SOURCE_DIR/build-tsps-o3"
EXPORT_DIR="/root/gl4es-tsps-export-o3"
ARCHIVE="/root/gl4es-tsps-o3.tar.gz"
BACKUP_DIR="/root/gl4es-tsps-libbackup"
...
if [ "$MISSING" -ne 0 ]; then
    ...
    echo "Something has reset /root/gl4es-tsps. Not building."
    exit 1
fi
