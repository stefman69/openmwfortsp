...
namespace
{
    std::optional<MyGUI::GlyphInfo> getGlyphInfo(MyGUI::IFont* font, MyGUI::Char ch, int fontSize)
    {
...
namespace MWGui
{
    ...
    struct TypesetBookImpl : TypesetBook
    {
        ...
        MyGUI::IntRect mRect;
        // TSP_DIALOGUE_BOOK_FONT_SIZE_051_20260813
        int mFontSize = Settings::gui().mFontSize;
    ...
    struct TypesetBookImpl::Typesetter : BookTypesetter
    {
        ...
        Typesetter(int width, int height, int fontSize)
            : mPageWidth(width)
            , mPageHeight(height)
    ...
    namespace
    {
        ...
        struct GlyphStream
        {
            ...
            explicit GlyphStream(MyGUI::IFont* font, int fontSize, float left, float top, float z, MyGUI::Vertex* vertices,
    ...
    public:
        ...
        */
        void doRender(TextFormat& textFormat)
        {
            ...
            GlyphStream glyphStream(textFormat.mFont, mBook->mFontSize, static_cast<float>(mCoord.left),
