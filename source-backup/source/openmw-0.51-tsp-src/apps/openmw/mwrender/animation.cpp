...
namespace MWRender
{
    ...
    void Animation::setObjectRoot(const std::string& model, bool forceskeleton, bool baseonly, bool isCreature)
    {
        ...
        // TSP_ROOM_RENDER_SAFETY_051_V30_R9 LIGHT_CALLBACK_BYPASS
        // Light residency is controlled by Scene R8. Do not let the older
        // screen-depth curtain make a resident light source disappear.
        ...
        // Structural tier: real ESM Static roots do NOT get the VISGRID callback.
        // Walls/floors/stairs/large static room shells therefore remain governed by
        // ordinary OpenMW rendering only. Actors and doors already bypass VISGRID.
        if (!tspDiagActor && !tspDiagDoor && !tspIsStatic && !tspIsLight)
        {
            ...
            // TSP_ROOM_RENDER_SAFETY_051_V30_R9 CALLBACK_PVS_DISABLED
            // V30/R4 Scene residency is the sole gameplay room/floor topology authority.
