...
WORK="$HOST_DIR/openmw-tsp-manager-v2.8"
...
BUILD_LOG="$WORK/openmw-manager-v28-build-$STAMP.log"
STATE="$HOST_DIR/openmw-manager-v28-install.state"
...
collect_action() {
    ensure_ssh
    local out="$HOST_DIR/openmw-manager-v28-diagnostics-$STAMP.tar.gz"
...
exec > >(tee "$WORK/openmw-manager-v28-install-$STAMP.log") 2>&1

cat <<'BANNER'
============================================================
OPENMW 0.51 TSP — MANAGER V2.8
OMWSCRIPTS ARE CONTENT + ORPHANED CONTENT REPAIR
============================================================
...
DEVICE_BACKUP="$ROOT/launcher/install-backups/manager-v28-before-$STAMP"
...
sync
echo "PASS Manager V2.8 installed and self-tested on device"
