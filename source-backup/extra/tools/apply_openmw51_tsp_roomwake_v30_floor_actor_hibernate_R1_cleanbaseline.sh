...
LOG="$DL/openmw51-roomwake-v30-r1-$STAMP.log"
BUILD_LOG="$DL/openmw51-roomwake-v30-r1-build-$STAMP.log"
STATE="$DL/openmw51-roomwake-v30-r1.state"
...
echo "CONTROLLER REVISION: V30-R1 CLEAN SIX-FILE BASELINE"
echo "============================================================"
...
echo
echo "===== 3/10 RESTORE COMPLETE CLEAN V27 BASELINE, THEN APPLY V30 C++ ====="
...
echo "===== 10/10 SAVE STATE / FINAL HASHES ====="
{
    ...
    printf 'V27_SOURCE_BASE=%q\n' "$V27_SOURCE_BASE"
    printf 'V27_AUX_BASE=%q\n' "$V27_AUX_BASE"
