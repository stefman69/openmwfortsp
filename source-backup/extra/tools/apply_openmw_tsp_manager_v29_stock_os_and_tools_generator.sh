...
static void header(Framebuffer&f){f.rect(0,0,f.width(),68,{9,10,12});label(f,"OPENMW 0.51",28,18,3,ACC);label(f,"TRIMUI SMART PRO MANAGER",270,25,2,FG);label(f,"INTEGRATED V2.8",1010,25,2,DIM);f.rect(0,68,f.width(),2,ACC);}
...
host_selftest() {
    ...
    grep -Fq 'INTEGRATED V2.8' "$CPP" || fail 16 "V2.8 UI marker missing"
