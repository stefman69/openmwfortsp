...
namespace MWLua
{
    ...
    sol::table initCameraPackage(sol::state_view lua)
    {
        ...
        api["setInteriorAdaptiveHeightMode"] = [](int mode) {
            MWRender::setInteriorAdaptiveHeightMode(mode);
        };
        api["getInteriorAdaptiveHeightMode"] = []() {
            return MWRender::getInteriorAdaptiveHeightMode();
        };
