...
namespace MWRender
{
        ...
        , mGroundCoverStore(groundcoverStore)
    {
        ...
        // TSP_GL4ES_DISABLE_OPAQUE_DEPTH_UNIT_051_V1
        // A negative unit makes PerViewUniformStateUpdater skip the depth bind.
        ...
        // TSP_GL4ES_DISABLE_OPAQUE_DEPTH_051_V1
        resourceSystem->getSceneManager()->setOpaqueDepthTex(nullptr, nullptr);
        // TSP_GL4ES_DISABLE_NORMALS_RT_051_V6
        // GL4ES/OpenGL 2.1 on the TSP does not expose glColorMaski.
        // The normals MRT path requires indexed color masks on attachment 1,
        // so force the optional normals render target off for this build.
        resourceSystem->getSceneManager()->setSupportsNormalsRT(false);
        // TSP_GL4ES_DISABLE_WEATHER_DEPTH_OCCLUSION_051_V1
        ...
        // TSP_GL4ES_DISABLE_SOFT_PARTICLES_051_V1
