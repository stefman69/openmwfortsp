...
namespace Gui
{
    ...
    public:
        ...
        void sort();
        void addItem(std::string_view name, int verticalPadding = 0, int fontHeight = 0);
        ...
        // Keep an actual rendered list item inside the ScrollView viewport.
        void ensureItemVisible(MyGUI::Widget* item);
    ...
    private:
        ...
        struct ListItemData
        {
            ...
            ListItemData(std::string_view name, int verticalPadding, int fontHeight)
                : mName(name)
