...
namespace MWGui
{
    ...
    {
        // TSP_SAVE_TEXT_GUIDE_051_V13
        mControllerButtons.mY = mSaving ? "" : "#{OMWEngine:LoadingSelectCharacter}";
        if (mSaving)
        {
            mControllerButtons.mA = "";
            mControllerButtons.mB = "Backspace";
            mControllerButtons.mView = "#{Interface:Cancel}";
            mControllerButtons.mMenu = "#{Interface:Select}";
        }
        else
        {
            mControllerButtons.mA = "#{Interface:Select}";
            mControllerButtons.mB = "#{Interface:Cancel}";
            mControllerButtons.mView = "";
            mControllerButtons.mMenu = "#{Interface:Select}";
        }
    ...
    {
        // TSP_LOAD_CONFIRM_A_START_051_V9
