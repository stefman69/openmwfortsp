...
namespace MWRender
{
        ...
        , mShaderWaterStateSetUpdater(nullptr)
    {
        ...
        // 32-cell coverage with 128x128 subdivisions: 2048-unit squares.
        mWaterGeom = SceneUtil::createWaterGeometry(
            Constants::CellSizeInUnits * 32, 128, 192);
        // TSP_GL4ES_WATER_DEPTH_051_V2: GL_DEPTH_CLAMP disabled for gl4es/GLES2.
        ...
        // TSP_GL4ES_WATER_FIXED_HEIGHT_051_V2: camera-relative FudgeCallback disabled.
