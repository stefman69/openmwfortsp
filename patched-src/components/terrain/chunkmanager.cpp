...
namespace Terrain
{
    ...
    osg::ref_ptr<osg::Texture2D> ChunkManager::createCompositeMapRTT()
    {
        ...
        // TSP_COMPOSITE_GLES2_FIX: unsized GL_RGB is not colour-renderable in GLES2.
        // The Mali driver rejects it as an FBO colour attachment, which made
        // every composite map incomplete. GL_RGBA is renderable everywhere.
